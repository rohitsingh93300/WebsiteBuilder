                            ...
                            <div className='relative'>
                                <button
                                    ...
                                    <img referrerPolicy='no-referrer'
                                        src={userData ? userData.avatar : "https://ui-avatars.com/api/?name=Rohit+Singh"} alt="" className='w-9 h-9 rounded-full border border-white/20 object-cover hover:scale-105 transition' />
                                </button>
                                <AnimatePresence>
                                    {openProfile && (
                                        <motion.div
